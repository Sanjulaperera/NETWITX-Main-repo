...
export const Header = () => {
  return (
    ...
    <div className="relative z-10 max-w-7xl mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      ...
      Discover professionally designed templates for every purpose.
      From businesses to blogs, our responsive and stylish designs help bring your vision to life with ease.
      </p>
      <div className="pt-8">

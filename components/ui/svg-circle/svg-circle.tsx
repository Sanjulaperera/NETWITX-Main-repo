...
import { titleContents, type TitleContent } from "./svg-circle-content"

interface HandWrittenTitleProps {
  contentKey?: string
  customContent?: TitleContent
}

export default function HandWrittenTitle({ contentKey = "default", customContent }: HandWrittenTitleProps) {
  const content = customContent || titleContents[contentKey] || titleContents.default
